const pages = [
  {type:"cover",image:"assets/cover.png",title:"Boo & Pip’s|Halloween!",sub:"A cozy little book to read, repeat, and play",hot:{x:72,y:42,icon:"☾",label:"Wave hello to Boo and Pip",effect:"finale",sound:"magic"}},
  {image:"assets/lanterns.png",chapter:"Halloween together",title:"The friends can hang the lanterns.",text:"Glow, glow, glow!",side:"left",job:"Say it with Boo and Pip",hot:{x:50,y:39,icon:"✦",label:"Make the lanterns glow",effect:"power",sound:"magic"}},
  {image:"assets/costumes.png",chapter:"Halloween together",title:"The friends can try on costumes.",text:"Zip, zip, zip!",side:"right",job:"Say it with Boo and Pip",hot:{x:58,y:53,icon:"★",label:"Try on the costumes",effect:"practice",sound:"practice"}},
  {image:"assets/pumpkins.png",chapter:"Halloween together",title:"The friends can decorate pumpkins.",text:"Pat, pat, pat!",side:"left",job:"Stickers and washable paint",hot:{x:67,y:62,icon:"●",label:"Pat on a pumpkin sticker",effect:"pattern",sound:"pattern"}},
  {image:"assets/knock.png",chapter:"Halloween together",title:"The friends can knock on doors.",text:"Knock, knock, knock!",side:"right",job:"Stay with a grown-up",hot:{x:28,y:43,icon:"◉",label:"Knock on the friendly door",effect:"power",sound:"build"}},
  {image:"assets/share.png",chapter:"Halloween together",title:"The friends can share their treats.",text:"Yum, yum, yum!",side:"left",job:"Sharing makes hearts happy",hot:{x:60,y:68,icon:"♥",label:"Share a treat with a friend",effect:"care",sound:"heart"}},
  {image:"assets/dance.png",chapter:"Halloween together",title:"The friends can dance together.",text:"Boo, boo, boo!",side:"right",job:"A happy Halloween dance",hot:{x:45,y:60,icon:"♫",label:"Start the Halloween dance",effect:"finale",sound:"finale"}},
  {type:"end",image:"assets/cover.png",chapter:"All done",title:"Halloween is fun together.",text:"Hooray, hooray, hooray!",job:"Happy Halloween!",hot:{x:72,y:42,icon:"★",label:"Celebrate with Boo and Pip",effect:"finale",sound:"finale"}}
];
...
function pageMarkup(page,index){
  ...
  if(page.type==="cover"){
    ...
    return `<div class="cover" data-page><img class="page-image" src="${page.image}" alt="Boo the friendly ghost and Pip the black kitten wave in a pastel Halloween room."><div class="shade"></div><div class="cover-copy"><p class="mini">READ · REPEAT · PLAY</p><h1>${a}<em>${b}</em></h1><p>${page.sub}</p><div class="cover-ribbon"><i></i><i></i><i></i></div></div>${hot}</div>`;
  }
